require.config({
    shim: {
        ...
        'jquery_multiselect': ['bootstrap_multiselect', 'jquery'],
        'core': ['bootstrap', 'jquery'],

        // Bootstrap Colorpicker Js
        'bootstrap_colorpicker': ['jquery'],
    ...
    paths: {
        ...
        // plugins js file path
        'sparkline': '../assets/plugins/sparkline/sparkline.min',
        'summernote': '../assets/plugins/summernote/dist/summernote',
        'nestable': '../assets/plugins/nestable/jquery.nestable',
        'sweetalert': '../assets/plugins/sweetalert/sweetalert.min',

        // Bootstrap Colorpicker Js
        'bootstrap_colorpicker': '../assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker',

        // masked input Js
        'maskedinput': '../assets/plugins/jquery.maskedinput/jquery.maskedinput.min',
        'inputmask': '../assets/plugins/jquery-inputmask/jquery.inputmask.bundle',
